...
const czmlPath = [
    {
      ...
      version: "1.0",
      clock: {
        interval: "2021-01-08T10:00:00Z/2021-01-08T15:00:00Z",
    ...
    },
    {
      ...
      description:
        "<p>这是飞行器的飞行路径</p>",
      availability: "2021-01-08T10:00:00Z/2021-01-08T15:00:00Z",
      path: {
        material: {
          polylineOutline: {
            color: {
  ...
  //使czml加载并跟随id为path的飞机模型
  viewer.dataSources
  .add(Cesium.CzmlDataSource.load(czmlPath))
  .then(function (ds) {
