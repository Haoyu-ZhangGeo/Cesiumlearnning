...
const entity = viewer.entities.add({
    name :'vehicle',
    model:{
        uri:'../../asset/model/GroundVehicle/GroundVehicle.glb',
        minimumPixelSize:64
    },
    position:Cesium.Cartesian3.fromDegrees(118.3080,32.2700,0)
});
...
const silhouette = collection.add(Cesium.PostProcessStageLibrary.createSilhouetteStage());
 silhouette.enabled = true;
 silhouette.uniforms.color = Cesium.Color.GREEN;
