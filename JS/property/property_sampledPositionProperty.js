...
const property = new Cesium.SampledPositionProperty();
      property.addSample(Cesium.JulianDate.fromIso8601('2021-01-05T00:00:00.00Z'), 
      Cesium.Cartesian3.fromDegrees(114.0, 40.0, 500000.0));

  property.addSample(Cesium.JulianDate.fromIso8601('2021-01-05T10:00:00.00Z'), 
      Cesium.Cartesian3.fromDegrees(124.0, 55.0, 3000000.0));

      greenBox.position = property;
