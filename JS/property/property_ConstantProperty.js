...
//修改原有constantproperty的值
greenBox.box.dimensions.setValue(new Cesium.Cartesian3(400000.0, 300000.0, 100000.0));

//创建一个新的constantproperty
//greenBox.box.dimensions = new Cesium.Cartesian3(400000.0, 300000.0, 200000.0);