...
const colorProperty = new Cesium.SampledProperty(Cesium.Color);
      colorProperty.addSample(Cesium.JulianDate.fromIso8601('2021-01-05T00:00:00.00Z'), new Cesium.Color(0,1,0));
      colorProperty.addSample(Cesium.JulianDate.fromIso8601('2021-01-06T00:00:00.00Z'), new Cesium.Color(1,0,0));

      greenBox.box.material = new Cesium.ColorMaterialProperty(colorProperty);