...
const zLength = new Cesium.SampledProperty(Number);
      zLength.addSample(Cesium.JulianDate.fromIso8601('2021-01-05T00:00:00.00Z'),100000);
      zLength.addSample(Cesium.JulianDate.fromIso8601('2021-01-05T12:00:00.00Z'),900000);

      greenBox.box.dimensions = new Cesium.PropertyBag({
        x: 400000.0,
        y: 300000.0,
        z: zLength
    });